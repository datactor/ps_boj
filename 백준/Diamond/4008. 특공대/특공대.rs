...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    for i in 1..=n {
        ...
        let cur = Line {
            ...
            intercept: a * prefix_sum[i] * prefix_sum[i] - b * prefix_sum[i] + ans + a * prefix_sum[i] * prefix_sum[i] + b * prefix_sum[i] + c,
        };
    ...
    writeln!(output, "{}", ans + a * prefix_sum[n] * prefix_sum[n] + b * prefix_sum[n] + c)?;
